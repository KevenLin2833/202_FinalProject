...
tempActive %>% ggplot(mapping = aes(x=Health.issue.during.lockdown, y=n, fill = Health.issue.during.lockdown)) + geom_col() + geom_text(aes(label = n)) + ggtitle('Active Students vs Health Issues')


tempNonActive  %>% ggplot(mapping = aes(x=Health.issue.during.lockdown, y=n, fill = Health.issue.during.lockdown)) + geom_col() + geom_text(aes(label = n)) + ggtitle('Non-Active Students vs Health Issues')
...
tempActive %>% ggplot(mapping = aes(x=Health.issue.during.lockdown, y=n, fill = Health.issue.during.lockdown)) + geom_col() + geom_text(aes(label = n)) + ggtitle('Social Media: Active Students vs Health Issues')


tempNonActive %>% ggplot(mapping = aes(x=Health.issue.during.lockdown, y=n, fill = Health.issue.during.lockdown)) + geom_col() + geom_text(aes(label = n)) + ggtitle('Social Media: Non-Active Students vs Health Issues')
```
# --- 
